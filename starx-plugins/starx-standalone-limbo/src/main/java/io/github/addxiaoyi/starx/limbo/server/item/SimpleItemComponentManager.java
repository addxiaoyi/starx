...
import io.github.addxiaoyi.starx.limbo.server.item.type.BooleanItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.ComponentItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.ComponentsItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.DyedColorItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.EmptyItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.EnchantmentsItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.GameProfileItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.IntItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.StringItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.StringsItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.TagItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.VarIntItemComponent;
import io.github.addxiaoyi.starx.limbo.server.item.type.WriteableItemComponent;
