...
import io.github.addxiaoyi.starx.event.LoginLimboRegisterEvent;
import io.github.addxiaoyi.starx.limbo.injection.dummy.ClosedChannel;
import io.github.addxiaoyi.starx.limbo.injection.dummy.ClosedMinecraftConnection;
import io.github.addxiaoyi.starx.limbo.injection.dummy.DummyEventPool;
import io.github.addxiaoyi.starx.limbo.injection.login.confirmation.LoginConfirmHandler;
import io.github.addxiaoyi.starx.limbo.injection.packet.ServerLoginSuccessHook;
import io.github.addxiaoyi.starx.limbo.injection.tablist.RewritingKeyedVelocityTabList;
import io.github.addxiaoyi.starx.limbo.injection.tablist.RewritingVelocityTabList;
import io.github.addxiaoyi.starx.limbo.injection.tablist.RewritingVelocityTabListLegacy;
import io.github.addxiaoyi.starx.limbo.utils.LambdaUtil;
...
public class LoginListener {
  ...
  public void hookInitialServer(PlayerChooseInitialServerEvent event) {
    RegisteredServer nextServer = this.plugin.takeNextServer(event.getPlayer());
    if (nextServer != null) {
