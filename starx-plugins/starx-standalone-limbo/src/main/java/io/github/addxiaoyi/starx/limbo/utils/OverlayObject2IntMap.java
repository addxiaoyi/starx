...
package io.github.addxiaoyi.starx.limbo.utils;
...
public class OverlayObject2IntMap<K> extends OverlayMap<K, Integer> implements Object2IntMap<K> {
  ...
  public IntCollection values() {
    return IntImmutableList.toList(Streams.concat(
        ((Object2IntMap<K>) this.parent).values().intStream().boxed(),
        ((Object2IntMap<K>) this.overlay).values().intStream().boxed()).mapToInt(Integer::intValue));
  }
